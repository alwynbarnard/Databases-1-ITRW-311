...
CREATE TABLE BANK(
    Bank_Code NUMBER(6) NOT NULL CONSTRAINT bank_code_pk PRIMARY KEY,
    Bank_Name VARCHAR(35) NOT NULL, 
    CONSTRAINT bank_name_uk UNIQUE(Bank_Name)
);

CREATE TABLE ARTIST(
    Artist_ID NUMBER(6) NOT NULL ,
    Bank_Code NUMBER(6) NOT NULL,
...
CREATE TABLE COLLECTION(
    Collection_ID NUMBER(6) NOT NULL,
    Artist_ID NUMBER(6)NOT NULL,
...
CREATE TABLE SALE_TRANSACTION(
    ...
    VAT NUMBER(5,2) NOT NULL,
    Delivery_Method VARCHAR(25) NOT NULL,
    Sales_Total NUMBER(8,2) NOT NULL,
    CONSTRAINT transaction_id_pk PRIMARY KEY (Transaction_ID),
    CONSTRAINT client_id_fk FOREIGN KEY (Client_ID) REFERENCES KLIENT(Client_ID),
